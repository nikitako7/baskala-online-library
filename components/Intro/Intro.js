    ...
    <section className={styles.intro}>
      <div className={styles.intro__content}>
        <div className={styles.intro__left}>
          ...
          <p>
            { curLanguage === 'tt' && 'Başqala проекты — ул онлайн татар әдәбияты китапханәсе. Сайтта татар язычуларының Һәм шагыйрьләрнең әдәби әсәрләре, шулай ук, татар теленә тәрҗемә ителгән бөтендөнья әдәбияте классикасы җыелган. Başqala белән милли мәдәнияткә чумып алыгыз әле!' }
